...
import { Button, Dialog, FormControlLabel, Radio, RadioGroup, Switch, TextField } from '@mui/material';
...
const TraderList = () => {
    ...
    const FundAddFn = async (id) => {
        try {
            const res = await apiConnectorPost(endpoint?.update_balance, {
    ...
    return (
        <div className="p-2">
            ...
            <Dialog
                ...
                maxWidth="xs"
                fullWidth >
                <div className='text-center my-5 font-bold'> Fund Request </div>
                <RadioGroup
                    row
                    value={txnType}
                ...
                <div className='flex gap-5  justify-end m-5'>
                    <Button className='!bg-red-500 !text-white' onClick={() => {
                        ...
                        Cancel</Button>
                    <Button className='!bg-blue-500 !text-white' onClick={() => FundAddFn(selectedTraderId)}>Submit</Button>
                </div>
            </Dialog>
